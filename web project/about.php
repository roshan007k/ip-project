...
<body>
	...
	<div class="sec1" style="background-color:#ffffff;height: 100%;">
		...
		<section style="background-color: #d5d06e;margin-top: 20px;">
			...
			<button class="button5"><a href="donation.php"style="text-decoration: none;">Click here to donate</button></a>
		</section>
		<section style="background-color: #d5d06e;margin-top: 20px;">
			...
			<br>
			<br>
			<button class="button6"><a href="home.php"style="text-decoration: none;">Continue to shop</button></a>
		</section>
	</div>
